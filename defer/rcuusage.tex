...
is weaker than the \IX{existence guarantee}s discussed
...
discuss \IX{existence guarantee}s and describe how a mechanism
...
conjunction with \IXh{sequence}{lock}s, per-CPU locks, and per-data-structure
