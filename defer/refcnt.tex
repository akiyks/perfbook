...
\IXB{Reference count}ing tracks the number of references to a given
object in order to prevent that object from being prematurely freed.
...
by \pplsur{Ben}{Gamsa} et al.~\cite{Gamsa99}.
