...
We might hope that this assignment to \co{gptr} could use a
\IXalt{simple C-language assignment statement}{plain access}.
Unfortunately,
...
This approach is termed \IXacr{qsbr}~\cite{ThomasEHart2006a}.
A \acr{qsbr} schematic is shown in
...
Although production-quality \IXacr{qsbr} implementations can be quite complex,
...
Readers are instead protected by the \acr{qsbr} techniques described in this section.
