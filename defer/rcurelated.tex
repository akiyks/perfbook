...
\ppl{Mathieu}{Desnoyers} created a user-space \acr{rcu} for use in
...
\IXacr{srcu}~\cite{PaulEMcKenney2006c}.
...
portion of Linux-kernel Tree \acr{rcu}.
...
was hiding a real bug (since fixed) in Tiny \acr{rcu}.
