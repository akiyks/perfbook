...
\ppl{Mathieu}{Desnoyers} created a \IXhacrrcu{userspace}{Userspace RCU} for use in
...
semantics of \IXacr{rcu} in terms of separation logic, and have continued with
...
of Linux-kernel \IXhAcrrcu{tree}{Tree RCU}\@.
...
\IXhacrrcu{sleepable}{Sleepable RCU} (SRCU)~\cite{PaulEMcKenney2006c}.
