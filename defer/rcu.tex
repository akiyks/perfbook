...
primitives or real-time-unfriendly \IXacrpl{ipi} in
...
in read-side primitives, or \acrpl{ipi} in update-side
primitives.
These schemes' shortcomings raise the question of
whether it is possible to do better.

This section introduces \IXacrfst{rcu}, which provides
