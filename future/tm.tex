...
The idea of supporting memory-based transactions, or \IXacr{tm}, in hardware
...
\item	Use only software \acr{tm} implementations, which are
	...
	the simpler of the hardware TM (\IXacr{htm}) implementations.
	Of course, software TM (\IXacr{stm}) tends to have higher
