...
Not long after, Shavit and Touitou proposed a
\IXalth{software-only implementation of transactional memory (STM)}
{Software transactional memory (STM)}{Transactional memory (TM)!software (STM)}
that was capable of running on commodity
