...
\epigraph{Everything should be as simple as it can be, but not simpler.}
	 {\pplEP{Albert}{Einstein}, by way of \pplEP{Louis}{Zukofsky}}
...
The idea of supporting memory-based transactions, or
\IXBacrfst{tm}, in hardware
...
Not long after, \pplsur{Nir}{Shavit} and \pplsur{Dan}{Touitou} proposed
a software-only implementation
of transactional memory (\IXacr{stm}) that was capable of running on commodity
...
\pplsur{Maurice P.}{Herlihy} et al.~\cite{HerlihyLMS03}
...
\pplsur{Lance}{Hammond} et al.~\cite{LanceHammond2004a}
...
\pplsur{William N. III}{Scherer} and
\pplsur{Michael L.}{Scott}~\cite{WilliamNSchererIII2005}
...
\pplsur{Donald E.}{Porter} and \pplsur{Emmett}{Witchel}~\cite{DonaldEPorter2007TRANSACT,Ramadan:2008:DTM:1521747.1521799}
...
\IXh{Sequence}{lock}ing, described in
