...
\IXr{PPCMEM} and \IXaltr{\co{herd}}{herd} can in theory directly input assembly language
and C++ code, but these tools work only on very small \IXpl{litmus test},
...
many formal-verification tools, including
\IXacr{promela}/\IXaltacr{spin}{spin}, are
restricted to \IXalthalt{sequential consistency}{sequential}{memory consistency}.
