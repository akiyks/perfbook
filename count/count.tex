...
This section covers the common special case of \IXpl{statistical counter}, where
...
\IXalth{approximate}{approximate}{limit counter} in
...
One possible design for \IXpl{limit counter} is to divide the limit of 10,000
...
we need a \IXalth{limit counter}{exact}{limit counter}
...
The variables and access functions for a simple \IXh{atomic}{limit counter}
are shown in
...
\QuickQuiz{
	...
	and \IXpl{memory barrier} are required to reliably communicate
...
shows the data structures used by the \IXalth{signal-theft based counter}
...
\IXacrfpl{dsp}, \IXacrfpl{fpga}, or \IXacrfpl{gpgpu}, you may need
