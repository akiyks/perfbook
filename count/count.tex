...
\IXalthx{}{Approximate limit counters}{|(}{Limit counters}{approximate|(}%
...
\IXalthx{}{Exact limit counters}{|(}{Limit counters}{exact|(}%
...
\Clnrefrange{fast:b}{loop:e} of the fastpath form a \IXacr{cas} loop, with
