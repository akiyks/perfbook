...
\num{100 014 000} times, but the final value of the counter was only
\num{52 909 118}.
...
\QuickQuizAnswer{
	...
	Under this assumption, if $f$ is less than or equal to \num{0.5},
	...
	On the other hand, if $f$ is greater than \num{0.5}, $1-f$ of
...
One possible design for limit counters is to divide the limit of \num{10 000}
...
\QuickQuiz{}
	...
	What would you do if you had (say) \num{10 000} threads and needed
...
\centering
\begin{tabular}
{lrS[table-format=2.1]S[table-format=3.0]S[table-format=5.0]}
	\toprule
...
penalty, although on this \num{4.7}\,GHz Power-6 system that penalty can be reduced
...
\QuickQuiz{}
	The \co{++} operator works just fine for \num{1000}-digit numbers!
