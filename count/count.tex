...
\Clnrefrange{fast:b}{loop:e} of the fastpath form a \IXacrmf{cas} loop, with
...
expense of adding \IX{atomic} operations to the fastpaths, which slow down
...
multithreaded code, and \IX{atomic} operations to a single variable neither
...
\IXacrpl{dsp}, \IXacrpl{fpga}, or \IXacrfstpl{gpgpu}, you may need
to pay close attention to the ``Interacting With Hardware'' bubble
throughout the design process.
For example, the structure of a \acr{gpgpu}'s hardware threads and memory
