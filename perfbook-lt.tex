...
\newcommand{\IXacr}[1]{\glsuseri{#1}\gls{#1}} % put index via acronym dictionary
\newcommand{\IXacrpl}[1]{\glsuseri{#1}\glspl{#1}} % put index via acronym dictionary (plural)
\newcommand{\IXAcr}[1]{\glsuseri{#1}\Gls{#1}} % put index via acronym dictionary (upper case)
\newcommand{\IXAcrpl}[1]{\glsuseri{#1}\Glspl{#1}} % put index via acronym dictionary (upper case, plural)
...
\newcommand{\IXacrl}[1]{\glsuseri{#1}\glsxtrlong{#1}} % put index via acronym dictionary (long form)
\newcommand{\IXacrlpl}[1]{\glsuseri{#1}\glsxtrlongpl{#1}} % put index via acronym dictionary (long form, plural, plural)
\newcommand{\IXAcrl}[1]{\glsuseri{#1}\Glsxtrlong{#1}} % put index via acronym dictionary (long form, upper case)
\newcommand{\IXAcrlpl}[1]{\glsuseri{#1}\Glsxtrlongpl{#1}} % put index via acronym dictionary (long form, upper case, plural)
...
\newcommand{\acrf}[1]{\glsxtrfull{#1}} % print acronym via dictionary (full form)
\newcommand{\acrfpl}[1]{\glsxtrfullpl{#1}} % print acronym via dictionary (full form, plural)
\newcommand{\Acrf}[1]{\Glsxtrfull{#1}} % print acronym via dictionary (full form, upper case)
\newcommand{\Acrfpl}[1]{\Glsxtrfullpl{#1}} % print acronym via dictionary (full form, upper case, plural)
\newcommand{\IXacrf}[1]{\glsuseri{#1}\glsxtrfull{#1}} % put index via acronym dictionary (full form)
\newcommand{\IXacrfpl}[1]{\glsuseri{#1}\glsxtrfullpl{#1}} % put index via acronym dictionary (full form, plural)
\newcommand{\IXAcrf}[1]{\glsuseri{#1}\Glsxtrfull{#1}} % put index via acronym dictionary (full form, upper case)
\newcommand{\IXAcrfpl}[1]{\glsuseri{#1}\Glsxtrfullpl{#1}} % put index via acronym dictionary (full form, upper case, plural)
...
\newcommand{\IXacrfst}[1]{\glsuseri{#1}\glsreset{#1}\gls{#1}} % put index via acronym dictionary (first form)
\newcommand{\IXacrfstpl}[1]{\glsuseri{#1}\glsreset{#1}\glspl{#1}} % put index via acronym dictionary (first form, plural)
\newcommand{\IXAcrfst}[1]{\glsuseri{#1}\glsreset{#1}\Gls{#1}} % put index via acronym dictionary (first form, upper case)
\newcommand{\IXAcrfstpl}[1]{\glsuseri{#1}\glsreset{#1}\Glspl{#1}} % put index via acronym dictionary (first form, upper case, plural)
