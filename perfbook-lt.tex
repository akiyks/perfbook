...
\newcommand{\indexhx}[4]{\ucindexh{#3}{#4}}
}{
\newcommand{\indexh}[3]{\ucindex{#1}}
\newcommand{\indexhr}[3]{\index{#1}}
\newcommand{\indexhx}[4]{\ucxindex{#1}{#2}}
}
...
\newcommand{\IXaltx}[3]{\hlindex{#1}\ucxindex{#2}{#3}} % for putting annotations for index ranges
\newcommand{\IXh}[3]{\hlindex{#1}\indexh{#1}{#2}{#3}}
\newcommand{\IXhr}[3]{\hlindex{#1}\indexhr{#1}{#2}{#3}}
\newcommand{\IXplh}[3]{\hlindex{#1s}\indexh{#1}{#2}{#3}}
\newcommand{\IXalth}[4]{\hlindex{#1}\indexh{#2}{#3}{#4}}
\newcommand{\IXalthr}[4]{\hlindex{#1}\indexhr{#2}{#3}{#4}}
\newcommand{\IXalthx}[5]{\hlindex{#1}\indexhx{#2}{#3}{#4}{#5}}
\newcommand{\IXacr}[1]{\gls{#1}\glsuseri{#1}} % put index via acronym dictionary
\newcommand{\IXacrb}[1]{\glsuserii{#1}}
\newcommand{\IXacre}[1]{\glsuseriii{#1}}
...
\include{indexsee}
\IfIndexHier{
\include{indexseehier}
}{}
\phantomsection
\IfTwoColumn{}{
\newgeometry{body={6.5in,8.25in},centering=true,onecolumn}
}
\printglossaries
\phantomsection
\printindex
