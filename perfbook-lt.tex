...
\newboolean{buggyfirstaid}
\setboolean{buggyfirstaid}{false}
...
% work around a wack-a-mole behavior of cleveref
%  -- tentative measure for latex-dev as of Mar. 1, 2025
\IfPackageAtLeastTF{amsmath}{2025/01/19}{
\input{fixfirstaid.ltx}
}{}
