...
\newindex[API Index]{api}
\newcommand{\categapi}[1]{~\fbox{\scriptsize #1}}
\newcommand{\apic}[1]{\co{#1}\sindex[api]{#1@\co{#1}\categapi{c}}}
\newcommand{\apig}[1]{\co{#1}\sindex[api]{#1@\co{#1}\categapi{g}}}
\newcommand{\apipx}[1]{\co{#1}\sindex[api]{#1@\co{#1}\categapi{px}}}
\newcommand{\apik}[1]{\co{#1}\sindex[api]{#1@\co{#1}\categapi{k}}}
\newcommand{\apikh}[1]{\co{#1}\sindex[api]{#1@\co{#1}\categapi{k historic}}}
\newcommand{\apipf}[1]{\co{#1}\sindex[api]{#1@\co{#1}\categapi{pf}}}
\newcommand{\apiur}[1]{\co{#1}\sindex[api]{#1@\co{#1}\categapi{userspace RCU}}}
\newcommand{\api}[1]{\co{#1}\sindex[api]{#1@\co{#1}}}
\newcommand{\apialtc}[2]{\co{#1}\sindex[api]{#2@\co{#2}\categapi{c}}}
\newcommand{\apialtg}[2]{\co{#1}\sindex[api]{#2@\co{#2}\categapi{g}}}
\newcommand{\apialtk}[2]{\co{#1}\sindex[api]{#2@\co{#2}\categapi{k}}}
