...
\newcommand{\IXacrfpl}[1]{\glsuseri{#1} \glsxtrlongpl{#1} (\glsxtrshortpl{#1})} % put index via acronym dictionary (full form, plural)
\newcommand{\IXAcrf}[1]{\glsuseri{#1}\Glsxtrlong{#1} (\glsxtrshort{#1})} % put index via acronym dictionary (full form, upper case)
