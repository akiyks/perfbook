...
\usepackage[split,makeindex]{splitidx} % for a seperate Index of API
\newindex[API Index]{api}
\newcommand{\api}[2]{\co{#1}\sindex[api]{#2@\co{#1}}}
...
% Index is in appendix if enabled
