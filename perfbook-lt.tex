...
\setboolean{newtxoneseven}{false} % newtx version 1.7 or later (set by autodate.sh)
\newboolean{qqzbg}
\setboolean{qqzbg}{true} % overriden by target specific setting
\newcommand{\IfQqzBg}[2]{\ifthenelse{\boolean{qqzbg}}{#1}{#2}}
\usepackage[table,svgnames]{xcolor}
\usepackage[breakable,skins]{tcolorbox} % need to be ahead of tcolorbox
\input{autodate} % need to input here to get package version status
\usepackage{iftex}
\ifPDFTeX
...
\else % luatex or xetex
  \ifthenelse{\boolean{newtxoneseven}}{ % newtx 1.7 or later needs nofontspec
                                        % to keep existing font choices
    \usepackage[defaultsups,helvratio=0.9,nofontspec]{newtxtext}
  }{
    \usepackage[defaultsups,helvratio=0.9]{newtxtext}
  }
\fi
% suppress harmless warnings from tcolorbox >=v6.0.0 (for lualatex)
\ifLuaTeX
  \usepackage{luacolor}
\fi
