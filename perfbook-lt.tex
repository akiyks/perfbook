...
\newcommand{\IX}[1]{\hlindex{#1}\ucindex{#1}} % put with first letter capitalized into general index
\newcommand{\IXr}[1]{\hlindex{#1}\index{#1}} % put as is into general index
\newcommand{\IXpl}[1]{\hlindex{#1s}\ucindex{#1}} % put with first letter capitalized into general index for plural
\newcommand{\IXplr}[1]{\hlindex{#1s}\index{#1}} % put as is into general index for plural
\newcommand{\IXalt}[2]{\hlindex{#1}\ucindex{#2}} % put alternative with first letter capitalized into general index
\newcommand{\IXaltr}[2]{\hlindex{#1}\index{#2}} % put alternative as is into general index
\newcommand{\IXh}[2]{\hlindex{#1 #2}\indexh{#1 #2}{#2}{#1}}
\newcommand{\IXhpl}[2]{\hlindex{#1 #2s}\indexh{#1 #2}{#2}{#1}}
\newcommand{\IXhr}[2]{\hlindex{#1 #2}\indexhr{#1 #2}{#2}{#1}}
\newcommand{\IXalth}[3]{\hlindex{#1}\indexh{#1}{#3}{#2}}
\newcommand{\IXalthr}[3]{\hlindex{#1}\indexhr{#1}{#3}{#2}}
\newcommand{\IXacr}[1]{\gls{#1}\glsuseri{#1}} % put index via acronym dictionary
\newcommand{\IXacrpl}[1]{\glspl{#1}\glsuseri{#1}} % put index via acronym dictionary (plural)
\newcommand{\IXAcr}[1]{\Gls{#1}\glsuseri{#1}} % put index via acronym dictionary (upper case)
\newcommand{\IXAcrpl}[1]{\Glspl{#1}\glsuseri{#1}} % put index via acronym dictionary (upper case, plural)
...
\newcommand{\IXacrl}[1]{\glsxtrlong{#1}\glsuseri{#1}} % put index via acronym dictionary (long form)
\newcommand{\IXacrlpl}[1]{\glsxtrlongpl{#1}\glsuseri{#1}} % put index via acronym dictionary (long form, plural, plural)
\newcommand{\IXAcrl}[1]{\Glsxtrlong{#1}\glsuseri{#1}} % put index via acronym dictionary (long form, upper case)
\newcommand{\IXAcrlpl}[1]{\Glsxtrlongpl{#1}\glsuseri{#1}} % put index via acronym dictionary (long form, upper case, plural)
...
\newcommand{\IXacrf}[1]{\glsxtrfull{#1}\glsuseri{#1}} % put index via acronym dictionary (full form)
\newcommand{\IXAcrf}[1]{\Glsxtrfull{#1}\glsuseri{#1}} % put index via acronym dictionary (full form, upper case)
