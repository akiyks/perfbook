...
\usepackage{ifthen}
\usepackage{iftex}
\newboolean{newtxnofontspec}
\newboolean{newtxnotcompat}
\ifPDFTeX
  \usepackage[defaultsups,helvratio=0.9]{newtxtext} % use nice, standard fonts for roman
\else % assume lualatex or xelatex
  \input{newtxversion} % load info of newtx version (by autodate.sh)
  \ifthenelse{\boolean{newtxnofontspec}}{
    \usepackage[defaultsups,helvratio=0.9,nofontspec]{newtxtext}
  }{
    \ifthenelse{\boolean{newtxnotcompat}}{
      % newtx 1.72x doesn't work with perfbook under non-PDF latex
      % fall back to tex-gyre type1 packages
