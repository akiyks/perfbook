...
\newcommand{\indexrh}[3]{\indexrawh{#2}{#3}}
}{
\newcommand{\indexh}[3]{\ucindex{#1}}
\newcommand{\indexhr}[3]{\index{#1}}
\newcommand{\indexrh}[3]{\index{#1}}
}
...
\newcommand{\IXrh}[2]{\indexrh{#1 #2}{#2}{#1}\hlindex{#1 #2}}
\newcommand{\IXrhpl}[2]{\indexrh{#1 #2}{#2}{#1}\hlindex{#1 #2s}}
\newcommand{\IXalth}[3]{\indexh{#2 #3}{#3}{#2}\hlindex{#1}}
\newcommand{\IXalthalt}[3]{\indexh{#1}{#3}{#2}\hlindex{#1}}
\newcommand{\IXalthr}[3]{\indexhr{#2 #3}{#3}{#2}\hlindex{#1}}
\newcommand{\IXalthaltr}[3]{\indexhr{#1}{#3}{#2}\hlindex{#1}}
