...
(or ``\IXalthr{free lunch}{Moore's Law free lunch}%
{Moore's Law}{free lunch of}''~\cite{HerbSutter2008EffectiveConcurrency}),
as shown in
...
\IXalt{memory reference}{Memory reference cost}
may need to wait for a local cache lookup to complete
...
\IXacrb{3di}%
\Acr{3di} is the practice of bonding
...
Perhaps the most important benefit of \acr{3di} is decreased path length through
