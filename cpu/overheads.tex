...
The same-CPU \IXacrf{cas} operation consumes about seven
...
The ``same-CPU'' prefix means that the CPU now performing the \acr{cas} operation
...
A normal \acr{cas} operation consumes more than 400~nanoseconds, or almost
...
In this case, a blind \acr{cas} operation consumes more than three hundred
