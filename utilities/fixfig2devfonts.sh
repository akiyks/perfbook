# fixfig2devfonts.sh: Convert an .eps file from eps2dev to use
#                     embeddable fonts
#
...
sed -i  -e 's+Times-Roman-iso+NimbusSans-iso+g' \
	...
	-e 's+Helvetica-Narrow-iso+NumbausSans-Narrow-iso+g' \
	-e 's+Helvetica-Bold+NimbusSanL-Bold+g' \
	-e 's+Helvetica-Narrow+NimbusSansL-ReguCond+g' \
	...
	-e 's+NimbusMonL-Regu +DejaVuSansMono +g' $1
