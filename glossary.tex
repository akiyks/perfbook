...
\item[Embarrassingly Parallel:]\index{embarrassingly parellel}
	...
	CPUs are available).
\item[Exclusive Lock:]\index{lock!exclusive}\index{exclusive lock|see{lock, exclusive}}
...
\item[Read-Side Critical Section:]\index{critical section!read-side}\index{read-side critical section|see{critical section, read-side}}
...
\item[Reader-Writer Lock:]\index{lock!reader-writer}\index{reader-writer lock|see{lock, reader-writer}}
...
\item[Transactional Memory (TM):]\index{transactional memory}\index{TM|see{transactional memory}}
...
\item[Write-Side Critical Section:]\index{critical section!write-side}\index{write-side critical section|see{critical section, write-side}}
