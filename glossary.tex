...
\item[\IXalth{Associativity Miss}{Associativity miss}{Cache miss!associativity}:]
...
\item[\IXalt{Atomic}{Atomic operation}:]
...
\item[\IXalth{Capacity Miss}{Capacity miss}{Cache miss!capacity}:]
	A cache miss incurred because the corresponding CPU has recently
	accessed more data than will fit into the cache.
\item[\IXalth{Code Locking}{Code locking}{Locking!code}:]
...
\item[\IXalth{Communication Miss}{Communication miss}{Cache miss!communication}:]
...
\item[\IXalth{Data Locking}{Data locking}{Locking!data}:]
...
\item[\IXalth{Direct-Mapped Cache}{Direct-mapped cache}{Cache!direct-mapped}:]
...
\item[Embarrassingly Parallel:]\index{Embarrassingly parallel}
	...
	CPUs are available).
\item[\IXalth{Exclusive Lock}{Exclusive lock}{Lock!exclusive}:]
...
\item[Fragmentation:]\index{Fragmentation}
	...
	actually requested.
\item[\IXalth{Fully Associative Cache}{Fully associative cache}{Cache!fully associative}:]
...
\item[\IXalt{Memory Consistency}{Memory consistency}:]
...
\item[\IXh{Pipelined CPU}{CPU!pipelined}:]
...
\item[\IXalth{Process Consistency}{Process consistency}{Memory consistency!process}:]
...
\item[\IXalth{Read-Side Critical Section}{Read-side critical section}{Critical section!read-side}:]
...
\item[\IXalth{Reader-Writer Lock}{Reader-writer lock}{Lock!reader-writer}:]
...
\item[\IXalth{Sequential Consistency}{Sequential consistency}{Memory consistency!sequential}:]
...
\item[\IXh{Superscalar CPU}{CPU!superscalar}:]
...
\item[\IXh{Vector CPU}{CPU!vector}:]
...
\item[\IXalth{Write Miss}{Write miss}{Cache miss!write}:]
...
\item[\IXalth{Write-Side Critical Section}{Write-side critical section}{Critical section!write-side}:]
