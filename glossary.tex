...
\item[\IXh{Associativity Miss}{Cache miss}{associativity}:]
...
\item[\IXh{Capacity Miss}{Cache miss}{capacity}:]
	A cache miss incurred because the corresponding CPU has recently
	accessed more data than will fit into the cache.
\item[\IXh{Code Locking}{Locking}{code}:]
...
\item[\IXh{Communication Miss}{Cache miss}{communication}:]
...
\item[\IXh{Data Locking}{Locking}{data}:]
...
\item[\IXh{Direct-Mapped Cache}{Cache}{direct-mapped}:]
...
\item[Embarrassingly Parallel:]\index{Embarrassingly parallel}
	...
	CPUs are available).
\item[\IXh{Exclusive Lock}{Lock}{exclusive}:]
...
\item[Fragmentation:]\index{Fragmentation}
	...
	actually requested.
\item[\IXh{Fully Associative Cache}{Cache}{fully associative}:]
...
\item[\IXhr{Pipelined CPU}{CPU}{pipelined}:]
...
\item[\IXh{Process Consistency}{memory consistency}{process}:]
...
\item[\IXh{Read-Side Critical Section}{Critical section}{read-side}:]
...
\item[\IXh{Reader-Writer Lock}{Lock}{reader-writer}:]
...
\item[\IXh{Sequential Consistency}{memory consistency}{sequential}:]
...
\item[\IXhr{Superscalar CPU}{CPU}{superscalar}:]
...
\item[Transactional Memory (TM):]\glsuseri{tm}
	...
	(hardware transactional memory, or HTM\glsuseri{htm}), in software (software
	transactional memory, or STM\glsuseri{stm}), or in a combination of hardware
	and software (``unbounded'' transactional memory, or UTM\glsuseri{utm}).
...
\item[\IXhr{Vector CPU}{CPU}{vector}:]
...
\item[\IXh{Write Miss}{Cache miss}{write}:]
...
\item[\IXh{Write-Side Critical Section}{Critical section}{write-side}:]
