...
\usepackage[nobottomtitles]{titlesec}[2016/03/21] % Suppress number in paragraph heading
\renewcommand{\bottomtitlespace}{0pt} % Permit raggedbottom before section title
\usepackage{fmtcount}
