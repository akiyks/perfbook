...
{numbers=left,numbersep=3pt,xleftmargin=5pt,xrightmargin=5pt}
\DefineVerbatimEnvironment{VerbatimU}{Verbatim}%
{numbers=none,xleftmargin=5pt,xrightmargin=5pt,samepage=true}

\surroundwithmdframed[hidealllines=false,leftmargin=0pt,skipabove=5pt,skipbelow=5pt,innerleftmargin=5pt,innerrightmargin=5pt,innertopmargin=5pt,innerbottommargin=5pt,backgroundcolor=blue!15]{VerbatimN}
\surroundwithmdframed[hidealllines=false,leftmargin=0pt,skipabove=5pt,skipbelow=5pt,innerleftmargin=5pt,innerrightmargin=5pt,innertopmargin=5pt,innerbottommargin=5pt,backgroundcolor=blue!15]{VerbatimU}
