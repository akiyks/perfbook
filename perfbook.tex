...
\usepackage{mathptmx,helvet} % use nice, standard fonts for roman, sans and monospace respectively
%\usepackage[scaled=0.93]{couriers}
...
\newcommand{\rrc}[3]{\begin{minipage}[t]{#1}{\RaggedRight #3 \vspace*{#2}}\end{minipage}}
