\renewcommand*{\CustomAcronymFields}{%
  ...
  first={\emph{\the\glslongtok}\space(\the\glsshorttok)},%
  firstplural={\emph{\the\glslongtok\noexpand\acrpluralsuffix}\space(\the\glsshorttok)},%
...
\IfIndexHier{
  \newcommand{\IXalthacrrcu}[3]{\hlindex{#1}\index{read-copy update (RCU)@\makefirstuc {read-copy update} (RCU)!#3}}
}{
  \newcommand{\IXalthacrrcu}[3]{\hlindex{#1}\index{#2}}
}
