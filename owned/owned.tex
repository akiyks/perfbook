...
For example, consider the per-thread \IX{statistical counter} implementation
shown in
...
\begin{enumerate}
\item	All message-passing environments, such as
	\IXacr{mpi}~\cite{MPIForum2008}
	and \IXacr{boinc}~\cite{BOINC2008}.
