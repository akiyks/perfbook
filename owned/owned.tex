...
\Epigraph{It is mine, I tell you.
	  ...
	  My precious.
	  Yes, my precious.}
	 {Gollum in \emph{The Fellowship of the Ring}, \pplEPmdl{J.R.R.}{Tolkien}}
...
\epigraph{Give thy mind more to what thou hast than to what thou hast not.}
	 {\pplEPmdl{Marcus Aurelius}{Antoninus}}
...
\epigraph{If the mountain will not come to Muhammad, then Muhammad must
	  go to the mountain.}
	 {\emph{Essays}, \pplEP{Francis}{Bacon}}
