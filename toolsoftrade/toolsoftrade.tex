...
The classic \IXacrm{cas} operation is provided by a pair of
...
Either of the \IXacrml{cas} operation is ``universal'' in the sense
...
the celebrated \IXacrmf{cas} operation is provided by
\apik{atomic_cmpxchg()}.
