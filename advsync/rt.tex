...
However, this approach introduces both overhead and \IX{deadlock}s.
...
nor is it permissible to use a retry loop, thus ruling out \IXh{sequence}{lock}s
and \IX{hazard pointer}s.
