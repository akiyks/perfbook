...
the \IXpl{statistical counter} described in
...
by \IXpl{memory barrier}, but in the not-uncommon case where linearizability
...
inimitable \ppl{Peter}{Denning}, who said of operating systems:
