...
\IXacrb{nbs}
The term \acr{nbs}~\cite{Herlihy90}
...
\begin{enumerate}
\item	\emph{\IX{Bounded wait-free synchronization}}: Every thread
	...
	omitted it.)
\item	\emph{\IX{Wait-free synchronization}}: Every thread will make progress
	in finite time~\cite{Herlihy93}.
\item	\emph{\IX{Lock-free synchronization}}: At least one thread will
	make progress in finite time~\cite{Herlihy93}.
\item	\emph{\IX{Obstruction-free synchronization}}: Every thread will
	make progress in finite time in the absence of
	contention~\cite{HerlihyLM03}.
\item	\emph{\IX{Clash-free synchronization}}: At least one thread will
	make progress in finite time in the absence of
	contention~\cite{DanAlitarh2013PracticalProgress}.
\item	\emph{\IX{Starvation-free synchronization}}: Every thread will
	make progress in finite time in the absence of
	failures~\cite{DanAlitarh2013PracticalProgress}.
\item	\emph{\IX{Deadlock-free synchronization}}: At least one thread will
	make progress in finite time in the absence of
	failures~\cite{DanAlitarh2013PracticalProgress}.
\end{enumerate}
...
using \apik{READ_ONCE()} and \apik{WRITE_ONCE()}.
...
instructions, although \IXacr{cas} instructions or a \apik{cmpxchg()}
primitive can also be used.
