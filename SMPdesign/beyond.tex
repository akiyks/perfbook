...
\IXacrpl{gpgpu}~\cite{ChristerEricson2008GPUMaze}, and even
...
combined into a \IXacr{cas} loop, with \acr{cas} failure indicating a loop in the
maze.
...
\IXacrl{cas} to mark a cell as visited, however
...
Fifth, the lightweight C++11 \IX{atomic} operations might improve performance.
