...
presented by \pplsur{Maged M.}{Michael} and
\pplsur{Michael L.}{Scott}~\cite{MichaelScott96},
...
\pplsur{Maged M.}{Michael}~\cite{DBLP:conf/europar/Michael03}.\footnote{
...
scalability~\cite{ChristophMKirsch2012FIFOisntTR}.\footnote{
	\ppl{Nir}{Shavit} produced relaxed stacks for roughly the same
