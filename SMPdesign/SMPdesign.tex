...
%
\Epigraph{Divide and rule.}{\pplEPraw{Philip II of Macedon}}
...
occur in \IX{critical section}s, which in turn causes code locking
...
Then the \IX{critical section}s for each part of the data structure
...
\QuickQuiz{
	...
	\item	Use \emph{\IX{hazard pointer}s}~\cite{MagedMichael04a}, which
...
uses coarse-grained parallelism with large \IX{critical section}s), and if
