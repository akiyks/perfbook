...
\epigraph{Follow every byway / Every path you know.}
	 {\emph{Climb Every Mountain}, \pplEPraw{Rodgers \& Hammerstein}}
...
\item	[\tco{cc -DSAFETY [-DCOLLAPSE] [-DMA=N] -o pan pan.c}]
	...
	when checking for \IX{livelock}s (AKA ``non-progress cycles'')
	via \co{-DNP}.
...
\item	Memory reordering.
	...
	by locks), but where you have no \IX{memory barrier}s.
