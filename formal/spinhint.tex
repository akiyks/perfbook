...
\IXacr{promela} is a language designed to help verify protocols, but which
can also be used to verify small parallel algorithms.
You recode your algorithm and correctness constraints in the C-like
language Promela, and then use \IXacr{spin} to translate it into a C program
...
The above site also gives links to \ppl{Gerard}{Holzmann}'s excellent
...
\IXh{weak}{memory ordering} must be explicitly coded.
...
This final example demonstrates a real-world use of Promela on \ppl{Oleg}
{Nesterov}'s
...
its \IXpl{memory barrier} were omitted, thus resulting in a buggy version
of QRCU\@.
...
\QuickQuiz{
	...
	\IXacr{promela}~\cite{Desnoyers:2013:MSM:2506164.2506174}),
