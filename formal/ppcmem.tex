...
this memory ordering, such as the \IXr{PPCMEM} tool produced by
...
\QuickQuiz{
	...
	subsequent loads.
	From an academic viewpoint, a \IXh{strong}{memory model} is one
...
The PPCMEM tool takes \emph{\IXpl{litmus test}} as input.
...
The key point is that if \co{atomic_add_return()} acts as a \IXh{full}
