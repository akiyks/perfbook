...
RCU implementations disable preemption across \IXrhpl{RCU read-side}
...
Although \ppl{Josh}{Triplett} and \pplalt{Paul McKenney}{McKenney, Paul E.}
...
did not come to a head until \ppl{Steve}{Rostedt} integrated a new dyntick
...
\end{VerbatimU}
	...
	\noindent could be modeled as something like:
...
\ppl{Manfred}{Spraul}~\cite{ManfredSpraul2008StateMachineRCU}.
...
\ppl{Andy}{Lutomirski}~\cite{PaulMcKenney2015dyntickAndyNMI},
