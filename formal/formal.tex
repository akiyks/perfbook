...
\Epigraph{Beware of bugs in the above code; I have only proved it correct,
	  not tried it.}{\pplEP{Donald}{Knuth}}
...
Testing, though essential, is insufficient, as fatal \IX{race condition}s
...
\epigraph{Western thought has focused on True-False;
	 ...
	 {\pplEPmdl{Nassim Nicholas}{Taleb}, summarized}
% Full quote:
...
\epigraph{Science is a first-rate piece of furniture for one's upper
	 ...
	 {\pplEPmdl{Oliver Wendell}{Holmes}, updated}
