...
``\IXh{capacity miss}{Cache miss}{capacity}'', because it is caused
...
The size (32 cache lines in this case) and
the \IXalt{associativity}{Cache associativity} (two in
...
``\IXh{associativity miss}{cache miss}{associativity}''.
...
\IXplh{direct-mapped cache}{cache}{direct-mapped}
...
aggressive about \IX{out-of-order execution} in general and re-ordering
