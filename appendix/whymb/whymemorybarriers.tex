...
In short, because reordering
\IXalt{memory references}{Memory reference (re)ordering}
allows much better performance,
...
Such a cache miss is termed
a ``\IXalth{capacity miss}{Capacity miss}{Cache miss!capacity}'',
...
\IXalt{associativity}{Cache associativity} (two in this case) are
collectively called the cache's
...
``\IXalth{associativity miss}{Associativity miss}{Cache miss!associativity}''.
...
\IXalth{direct-mapped caches}{Direct-mapped cache}{Cache!direct-mapped}
...
aggressive about \IXalt{out-of-order execution}{Out-of-order execution}
in general and re-ordering
\IXalt{memory references}{Memory reference (re)ordering} in particular.
...
of \IXalt{out-of-order execution}{Out-of-order execution}.
