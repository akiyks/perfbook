...
to participate in \IX{deadlock cycle}s.
...
counter to reach zero, surrounded by \IX{memory barrier}s.
...
participate in \IX{deadlock cycle}s, as it never spins nor blocks.
...
implementation of RCU based on \IX{quiescent state}s, with the data shown in
