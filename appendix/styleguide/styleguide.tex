...
the \path{CodeSamples/} directory of the perfbook source tree.
...
as is.  The script \path{utilities/fcvextract.pl} distinguishes
the type of source file by the suffix.
