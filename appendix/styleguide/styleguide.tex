...
in comments. (Tokens in comments might sound strange, but it does
have some restrictions).

As a workaround, meta commands are embedded in a litmus test
...
by the script \path{utilities/fcvextract.pl}.
