...
example, we might say that it must execute in less than 20\,\micro s
99.9\% of the time.
...
to complete in (say) 100\,\micro s than would that same network operation
...
below 100\,\micro s if use of the garbage collector is carefully avoided.
...
below 20\,\micro s, and specialty real-time operating systems (RTOSes)
...
shows timer processing taking place every 10\,\micro s, which
...
important non-realtime work is allotted at least 50\,ms
