...
This section looks at some special uses of \IXh{sequence}{lock}s.
...
protection of \apik{write_seqlock()}, while reads requiring
wedlock consistency are carried out within
a \apik{read_seqbegin()} / \apik{read_seqretry()} loop.
