...
\IXaltx{}{Memory reference (re)ordering}{|(}%
\Cref{sec:memorder:Why Hardware Misordering?}
...
\IXh{sequential consistency}{memory consistency}{sequential}.
...
Itanium offers a \IXh{weak consistency}{memory consistency}{weak}
