...
will demonstrate that real computer systems can reorder
\IXalt{memory references}{Memory reference (re)ordering},
...
\IXalt{speed of light}{Speed of light}
and the atomic nature of matter, will be slower
...
they can cause instructions and
\IXalt{memory references}{Memory reference (re)ordering} to execute out
...
\IXalt{memory references}{Memory reference (re)ordering} to be ordered?
...
scalability.
The next section overviews reordering of unrelated
\IXalt{memory reference}{Memory reference (re)ordering}.

\subsection{Memory-Reference Reordering}
\label{sec:memorder:Memory-Reference Reordering}

\IXalt{}{Memory reference (re)ordering|(}%
\Cref{sec:memorder:Why Hardware Misordering?}
...
\QuickQuizB{
	...
	\begin{fcvref}[ln:memorder:Enforced Ordering of Message-Passing Address-Dependency Litmus Test (Before v4.15)]
	The TSO platforms order all pairs of
	\IXalt{memory references}{Memory reference (re)ordering} except for
...
in mind that the \IXalt{speed of light}{Speed of light}
is finite and computers are of
non-zero size.
...
from a particular store, then, courtesy of the finite
\IXalt{speed of light}{Speed of light} and
...
order, number, and sizes of
\IXalt{memory references}{Memory reference (re)ordering} that your program
executes.
...
\IXalth{sequential consistency}{Sequential consistency}{Memory consistency!sequential}.
...
Itanium offers a
\IXalth{weak consistency}{Weak consistency}{Memory consistency!weak}
