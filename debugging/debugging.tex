...
in which RCU \IX{grace period}s stalled indefinitely.
...
known-benign \IX{data race}s, and also the \co{ASSERT_EXCLUSIVE_ACCESS()}
...
\epigraph{A lot of automation isn't a replacement of
	 ...
	 {Summarized from \pplEP{Stewart}{Butterfield}}
...
\QuickQuiz{
	...
	They should also spread the data across \IXr{NUMA node}s, memory
...
\epigraph{To err is human!
	  Stop being human!!!}{\pplEP{Ed}{Nofziger}}
