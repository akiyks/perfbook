...
Papers calling out the advantages of
\IXalth{multicore CPUs}{Multicore CPU}{CPU!multicore} were published
...
\IXalth{dual-core CPUs}{Dual-core CPU}{CPU!dual-core} in 2005.
Sun followed with the multicore/multi-threaded Niagara in late 2005.
In fact, by 2008, it was becoming difficult
to find a single-CPU desktop system, with
\IXalth{single-core CPUs}{Single-core CPU}{CPU!single-core} being
...
resources and \IXalt{replicating frequently accessed read-mostly resources}
