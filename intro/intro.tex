...
\IX{race condition}s, non-determinism,
...
\epigraph{Real difficulties can be overcome; it is only the imaginary
	  ones that are unconquerable.}{\pplEPmdl{Theodore N.}{Vail}}
...
partitioned over computer systems, mass-storage devices, \IXr{NUMA node}s,
