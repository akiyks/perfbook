...
\Epigraph{If you would only recognize that life is hard, things would be so
	  much easier for you.}{\pplEPmdl{Louis D.}{Brandeis}}
...
\epigraph{Cat:
	 ...
	 {\pplEP{Lewis}{Carroll}, \emph{Alice in Wonderland}}
...
\epigraph{Undertake something difficult, otherwise you will never grow.}
	 {Abbreviated from \pplEPmdl{Ronald E.}{Osburn}}
...
\item	If you prefer a more academic and rigorous treatment of
	...
	memory, all in Java.
	\pplalt{Michael Scott}{Scott, Michael L.}'s textbook%
	~\cite{MichaelScott2013Textbook}
...
it is to be hoped that \pplalt{Maged Michael}{Michael, Maged M.} some day
gives a talk whose video is archived.
...
\epigraph{If you become a teacher, by your pupils you'll be taught.}
	 {\pplEPalt{Oscar Hammerstein II}{Hammerstein, Oscar II}}
