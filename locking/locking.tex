...
undisciplined use of objects can easily result in
\IX{object-oriented spaghetti code}.
In \IX{object-oriented spaghetti code}, control flits from object to object
