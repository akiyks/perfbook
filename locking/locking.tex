...
\item	Many of locking's sins have pragmatic design solutions that
	...
	\item	Deadlock-detection tools, for example, the Linux kernel's
		\IXr{lockdep} facility~\cite{JonathanCorbet2006lockdep}.
...
respectively.
Another approach is to use the object-oriented ``\IXacrl{raii}'' (RAII)
...
of contention and getting fairness and high \IX{throughput} at high levels
of contention.
